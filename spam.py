...
┃╭━━┫┃┃╭╮┃╭╮┃╭╮┃╰━━╮┃┃┃┃┃┣━━╮┃
┃┃╱╱┃╰┫╰╯┃╰╯┃╰╯┃┃╰━╯┃┃┃┃┃┃╰━╯┃
╰╯╱╱╰━┻━━┻━━┻━━╯╰━━━┻╯╰╯╰┻━━━╯   By : Ghosth_Ice Attack ตัวหลุด +แจก+ดัดแปลงนิดๆ)''')

numbers = int(input("เบอร์เป้าหมาย : "))
count = int(input("จำนวน : "))

print ("++ เริ่มการโจมตีแล้ว! ++\n\n\n------------รายการ โจมตี------------")
...
print ("Success For attack\n\n------------------End credit------------------\n\n")
print ("discord : https://discord.gg/2kQZvwBqjR\n\n")

print ('''
###########################################
#                ICEACE_SHOP                #
#      เปิดขายสคริปใน discord นะครับ         #
#                                         #
#                                         #
#                                         #
#                                         #
...
print ("ระบบกำลังปิดโปรแกรมให้นะครับ ขอบคุณที่ใช้งาน")
time.sleep(3)
os.system("clear")
print('''
               HACKPUBG สวัสดีครับสามารถทักเฟส:นรก มือปราบ
               เรามีสิ่งของทาง cyber มากมาย ส่วนใหญ่จะเป็นddosนะครับ''')
time.sleep(5)
os.close